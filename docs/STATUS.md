...
- On 2026-07-23, direct source-owner permission resolved the rights gate for every catalog feed independently of separately published license metadata. This authorizes commercial use, result and trajectory redistribution, environment use, artifact retention, and derived-score publication; feeds still remain blocked whenever adapter, cadence, lineage, health, or ranking evidence is incomplete.
- Six MTEB retrieval families expose separate embedding and reranking shadow feeds under one component-configuration ranking group. Direct source-owner permission recorded on 2026-07-23 authorizes commercial use, result and trajectory redistribution, artifact retention, and derived-score publication; the repository code license remains separately recorded as Apache-2.0.
